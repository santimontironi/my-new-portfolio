...
export const webDesignAndLayout = [
    { icon: 'https://img.icons8.com/?size=100&id=20909&format=png&color=000000', name: 'HTML' },
    { icon: 'https://img.icons8.com/?size=100&id=21278&format=png&color=000000', name: 'CSS' }
]
